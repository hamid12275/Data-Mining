...
<h6 class="m-0 font-weight-bold text-primary">Catat Pengeluaran:</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
              ...
              <div class="col-sm-4">
              <label>Harga:</label>
        <input class="form-control form-control-sm" type="number" placeholder="Harga Barang..." aria-label=".form-control-sm example" name='jumlah' required>
              </div>
