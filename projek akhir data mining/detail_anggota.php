...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          if($ggl){
            ...
            $det=mysqli_query($conn, "select * from anggota where id='$id_brg'")or die(mysql_error());
  ...
  <?php
   ...
   <div class="col-md-3">
   <a href="daftar_anggota.php"><button type="button" class="btn btn-info">Kembali Lagi</button></a>
   </div>
