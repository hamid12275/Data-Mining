        ...
        <div class="container-fluid">
             ...
             <h6 class="m-0 font-weight-bold text-primary">Data Anggota:</h6>
                          ...
                          <div class="card-body">
                            ...
                            $jumlah_cos=mysqli_query($conn,"SELECT COUNT(*) as id from anggota");
                     ...
                     <a href="export_anggota.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
                             ...
                             <div class="col-md-4 mt-5 ">
                               <form class="form-inline my-2 my-lg-0" action="cari_anggota.php" method="get" name='cari'>
          ...
          if(isset($_GET['hapus'])){
             ...
             echo "</div>";
                             ...
                             if(isset($_GET['cari'])){
                              ...
                              $brg=mysqli_query($conn, "select * from anggota where id like '%".$cari."%' or nama like '%".$cari."%' or alamat like '%".$cari."%' ");
                           ...
                           if(mysqli_num_rows($brg) > 0){
                              ...
                              $brg=mysqli_query($conn, "select * from anggota limit $start, $hal");
                            }
                           ...
                           if(mysqli_num_rows($brg)){
                             ...
                             <tbody>
                               <tr>
                                 ...
                                 <td>&nbsp;<a href="edit_anggota.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="hapus_anggota.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp; <a href="detail_anggota.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-info">Detail</button></a></td>
